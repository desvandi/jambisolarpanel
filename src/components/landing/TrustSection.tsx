...
const trustItems = [
  ...
  },
  {
    ...
    desc: "Didukung oleh insinyur dan teknisi berpengalaman yang siap menangani proyek di seluruh Indonesia.",
  },
  {
    icon: HardHat,
  ...
  },
  {
    ...
    desc: "Portofolio proyek untuk rumah tangga, bisnis, perkebunan, dan institusi pemerintah.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    desc: "Melayani instalasi di seluruh Indonesia, dari kota besar hingga daerah terpencil tanpa listrik PLN.",
  },
];
