          ...
          <div className="glass rounded-3xl p-6 sm:p-10">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <div className="text-center p-4 rounded-2xl bg-gold/5 border border-gold/20">
                ...
                <p className="text-xs text-muted-foreground mb-1">
                  Profit Bersih 25 Tahun
                </p>
                <p className="text-xl sm:text-2xl font-bold text-gold">
                  {roi.returnMultiplier}x
                </p>
                <p className="text-[10px] text-muted-foreground">
                  Total: {formatRpShort(roi.return25Year + rec.price)}
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200 dark:border-emerald-800/30 mb-6">
              <p className="text-center text-sm text-emerald-700 dark:text-emerald-300 leading-relaxed">
                Investasi <strong>{rec.priceFormatted}</strong> menghasilkan
                total penghematan <strong>{formatRp(roi.return25Year + rec.price)}</strong> selama 25 tahun
                — keuntungan bersih <strong>{formatRp(roi.return25Year)}</strong>
                ({roi.returnMultiplier}x lipat investasi). Perhitungan ini memperhitungkan
                kenaikan tarif PLN rata-rata {Math.round(PLN_INCREASE_RATE_DEFAULT * 100)}%/tahun.
              </p>
            </div>
