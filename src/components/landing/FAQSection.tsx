...
const faqs = [
  {
    ...
    a: "Biaya instalasi panel surya bervariasi tergantung kapasitas sistem dan kebutuhan spesifik Anda. Untuk rumah tangga, paket mulai dari Rp25 juta untuk sistem 1 kWp (tanpa baterai) hingga Rp70 juta untuk 5 kWp. Untuk bisnis dan industri, paket mulai dari Rp100 juta (7 kWp). Semua harga sudah termasuk PPN 11%, peralatan, instalasi, survei, desain, dan garansi resmi. Tersedia opsi baterai LiFePO4 untuk semua paket — mulai dari 3 kWh (rumah tangga) hingga 48 kWh (industri). Tersedia juga add-on Kanopi Carport dan Smart Monitoring untuk semua paket. Kami menyediakan konsultasi dan survei gratis untuk memberikan estimasi biaya yang akurat sesuai kebutuhan Anda.",
  },
  {
    q: "Berapa lama balik modal (ROI)?",
    a: "Masa balik modal (ROI) bervariasi tergantung kapasitas sistem, pola penggunaan listrik, dan kenaikan tarif PLN. Berikut estimasi berdasarkan kondisi matahari Jambi (PSH 3,75 jam) dan self-consumption 70%: Untuk rumah tangga (Silver 2-5 kWp), ROI ~7-9 tahun pada tarif tetap, atau ~6-7 tahun dengan asumsi kenaikan tarif PLN 6%/tahun. Untuk bisnis dan industri (Gold & Platinum 7-20 kWp), ROI ~6-8 tahun pada tarif tetap, atau ~5-6 tahun dengan kenaikan tarif. Dalam 25 tahun umur panel, total penghematan kumulatif berpotensi mencapai 2-3x lipat investasi awal (termasuk kenaikan tarif PLN rata-rata 6%/tahun). Tambahkan baterai LiFePO4 jika ingin full backup 24 jam — ROI sedikit lebih lama namun kebebasan dari PLN padam sangat berharga. Catatan: angka di atas adalah estimasi dan dapat bervariasi tergantung pola konsumsi aktual, orientasi atap, dan kondisi lingkungan. Kami memberikan perhitungan ROI detail saat konsultasi.",
  },
  {
