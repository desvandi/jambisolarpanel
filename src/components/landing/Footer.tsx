      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl overflow-hidden bg-solar flex items-center justify-center">
                <Image
                  src="/logo-jmse.png"
                  alt="Logo JMSE — Jambi Solar Panel"
                  width={40}
                  height={40}
            ...
            <div className="flex gap-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-solar flex items-center justify-center transition-colors"
                aria-label="Facebook Jambi Solar Panel"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-solar flex items-center justify-center transition-colors"
                aria-label="Instagram Jambi Solar Panel"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/40">
            &copy; {new Date().getFullYear()} PT. Jaya Mandiri Smart Energy. All
            rights reserved.
          </p>
