      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-6 leading-tight">
            Diskon 5% +{" "}
            <span className="text-gold-light">Gratis Konsultasi & Desain Awal</span>
            <br />
            Hanya Berlaku Bulan Ini!
          </h2>

          <p className="text-lg text-white/70 mb-4 max-w-2xl mx-auto leading-relaxed">
            Jangan lewatkan kesempatan mendapatkan <strong className="text-gold-light">diskon 5%</strong> untuk semua paket panel surya,
            plus konsultasi dan desain sistem awal tanpa biaya. Harga akan naik bulan depan —
            amankan harga promo sekarang!
          </p>
          <p className="text-sm text-white/50 mb-10 max-w-2xl mx-auto">
            Kuota diskon terbatas setiap bulan. Segera hubungi kami
            sebelum penawaran berakhir.
          </p>
