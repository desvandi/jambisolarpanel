...
const features = [
  ...
  { icon: "🇮🇩", text: "Support Seluruh Indonesia" },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span>Dipercaya oleh Pelanggan Rumah & Bisnis</span>
          </motion.div>
          ...
          >
            ...
            <span className="gradient-text">Hingga 70%</span>{" "}
            dengan Sistem Panel Surya Profesional
          </motion.h1>
          ...
          >
            Instalasi PLTS Off-Grid, Hybrid, dan On-Grid untuk Rumah, Bisnis,
            Kebun, dan Industri. Solusi energi mandiri yang dirancang oleh
          ...
          >
            {[
              ...
              { value: 70, suffix: "%", label: "Potensi Hemat" },
              { value: 50, suffix: "+", label: "Proyek Terpasang" },
            ].map((stat) => (
              <div
                key={stat.label}
