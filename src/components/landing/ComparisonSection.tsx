...
const comparisons = [
  {
    ...
    solar: { icon: Zap, text: "Biaya sangat minimal setelah ROI", value: "Hampir Rp 0*", color: "text-solar" },
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sm text-muted-foreground mb-2">
            *Biaya listrik mendekati Rp 0 setelah masa ROI tercapai (estimasi 7-9 tahun). Biaya operasional (maintenance ringan) masih diperlukan.
          </p>
          <a
            href={WA_LINK}
            target="_blank"
