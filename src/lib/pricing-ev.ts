...
export const evPackages: EVPackage[] = [
  ...
  },
  {
    ...
    desc: "Solusi terintegrasi PLTS + EV Charger untuk rumah. Isi daya kendaraan listrik Anda dengan energi surya — gratis dari matahari. Sistem hybrid memastikan supply listrik stabil untuk rumah dan EV charging.",
  },
  {
