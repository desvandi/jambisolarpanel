...
const defaultDetailedState: DetailedState = {
  ...
  bos: {
    solarCablePerM: 18_000,
    acCablePerM: 12_000,
    mc4PerPair: 10_000,
    dcBreakerPerUnit: 75_000,
    acBreakerPerUnit: 20_000,
    avgCableLenPerPanel: 5,
    spd: 450_000,
    grounding: 750_000,
    lightningArrester: 300_000,
  },
  services: {
    laborPanel: 350_000,
